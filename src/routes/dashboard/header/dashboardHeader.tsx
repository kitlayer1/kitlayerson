...
const BlogIcon = () => (
  ...
  useVisibleTask$(({ cleanup }) => {
    const handleClickOutside = (event: MouseEvent) => {
      const menu = document.querySelector('.dashboard-user-menu-modal');
      const icon = document.querySelector('.dashboard-user-icon');
        ...
        <div class="dashboard-header-right">
          ...
          {isUserMenuOpen.value && user.value && (
            <div class="dashboard-user-menu-modal">
              ...
              <div
                class="dashboard-user-menu-item logout"
